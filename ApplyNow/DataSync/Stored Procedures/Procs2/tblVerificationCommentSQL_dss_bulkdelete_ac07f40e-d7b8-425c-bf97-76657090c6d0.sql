CREATE PROCEDURE [DataSync].[tblVerificationCommentSQL_dss_bulkdelete_ac07f40e-d7b8-425c-bf97-76657090c6d0]
...
DELETE [maint].[tblVerificationCommentSQL] 
OUTPUT DELETED.[LogVerificationCommentSQLID] INTO @changed FROM [maint].[tblVerificationCommentSQL] base JOIN
