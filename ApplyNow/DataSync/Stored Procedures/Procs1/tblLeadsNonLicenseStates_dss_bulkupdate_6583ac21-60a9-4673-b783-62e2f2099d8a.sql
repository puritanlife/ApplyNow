CREATE PROCEDURE [DataSync].[tblLeadsNonLicenseStates_dss_bulkupdate_6583ac21-60a9-4673-b783-62e2f2099d8a]
	@sync_min_timestamp BigInt,
	@sync_scope_local_id Int,
	@changeTable [DataSync].[tblLeadsNonLicenseStates_dss_BulkType_6583ac21-60a9-4673-b783-62e2f2099d8a] READONLY
AS
BEGIN
...
OR (changes.update_scope_local_id IS NULL AND changes.scope_update_peer_key IS NULL AND changes.local_update_peer_timestamp IS NULL) 
 THEN
UPDATE SET [ProductPlanPeriodID] = changes.[ProductPlanPeriodID], [UUID] = changes.[UUID], [StateID] = changes.[StateID], [Premium] = changes.[Premium], [StateLicenseTypeID] = changes.[StateLicenseTypeID], [Email] = changes.[Email], [CreatedDate] = changes.[CreatedDate], [LastModifiedDate] = changes.[LastModifiedDate]
