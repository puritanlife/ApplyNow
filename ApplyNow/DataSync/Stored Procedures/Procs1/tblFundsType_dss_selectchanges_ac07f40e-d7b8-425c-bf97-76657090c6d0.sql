CREATE PROCEDURE [DataSync].[tblFundsType_dss_selectchanges_ac07f40e-d7b8-425c-bf97-76657090c6d0]
...
ELSE @marker_scope_create_peer_key
 END) 
 end as sync_create_peer_key FROM [dbo].[tblFundsType] [base] FULL OUTER JOIN [DataSync].[tblFundsType_dss_tracking] [side] ON [base].[FundsTypeID] = [side].[FundsTypeID]
 WHERE 
