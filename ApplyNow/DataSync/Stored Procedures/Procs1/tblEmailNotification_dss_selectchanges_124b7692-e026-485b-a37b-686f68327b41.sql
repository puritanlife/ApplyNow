CREATE PROCEDURE [DataSync].[tblEmailNotification_dss_selectchanges_124b7692-e026-485b-a37b-686f68327b41]
...
ELSE @marker_scope_create_peer_key
 END) 
 end as sync_create_peer_key FROM [dbo].[tblEmailNotification] [base] FULL OUTER JOIN [DataSync].[tblEmailNotification_dss_tracking] [side] ON [base].[EmailNotificationID] = [side].[EmailNotificationID]
 WHERE 
