CREATE PROCEDURE [DataSync].[tblLexisNexisCallType_dss_bulkupdate_124b7692-e026-485b-a37b-686f68327b41]
...
(SELECT p.*, t.update_scope_local_id, t.scope_update_peer_key, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [DataSync].[tblLexisNexisCallType_dss_tracking] t ON p.[LexisNexisCallTypeID] = t.[LexisNexisCallTypeID]) as changes ON changes.[LexisNexisCallTypeID] = base.[LexisNexisCallTypeID]
