CREATE PROCEDURE [DataSync].[tblPeriodType_dss_bulkupdate_ac07f40e-d7b8-425c-bf97-76657090c6d0]
...
(SELECT p.*, t.update_scope_local_id, t.scope_update_peer_key, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [DataSync].[tblPeriodType_dss_tracking] t ON p.[PeriodTypeID] = t.[PeriodTypeID]) as changes ON changes.[PeriodTypeID] = base.[PeriodTypeID]
