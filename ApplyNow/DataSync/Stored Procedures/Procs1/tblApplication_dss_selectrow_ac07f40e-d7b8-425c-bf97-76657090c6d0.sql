CREATE PROCEDURE [DataSync].[tblApplication_dss_selectrow_ac07f40e-d7b8-425c-bf97-76657090c6d0]
	@P_1 Int,
...
as [ApplicationID], 
[base].[ProductPlanPeriodID], [base].[UUID], [base].[StateID], [base].[Premium], [base].[ForCompany], [base].[StatusTypeID], [base].[CanvasPolicyNumber], [base].[CreatedDate], [base].[LastModifiedDate], [base].[StateLicenseTypeID], (CASE WHEN [side].[local_create_peer_timestamp] IS NOT NULL 
