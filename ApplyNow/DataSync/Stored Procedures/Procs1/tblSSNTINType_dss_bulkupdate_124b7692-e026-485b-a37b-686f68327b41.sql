CREATE PROCEDURE [DataSync].[tblSSNTINType_dss_bulkupdate_124b7692-e026-485b-a37b-686f68327b41]
...
(SELECT p.*, t.update_scope_local_id, t.scope_update_peer_key, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [DataSync].[tblSSNTINType_dss_tracking] t ON p.[SSNTINTypeID] = t.[SSNTINTypeID]) as changes ON changes.[SSNTINTypeID] = base.[SSNTINTypeID]
