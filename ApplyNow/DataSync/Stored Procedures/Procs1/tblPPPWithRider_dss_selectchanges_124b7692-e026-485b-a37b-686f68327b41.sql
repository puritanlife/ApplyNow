CREATE PROCEDURE [DataSync].[tblPPPWithRider_dss_selectchanges_124b7692-e026-485b-a37b-686f68327b41]
...
ELSE @marker_scope_create_peer_key
 END) 
 end as sync_create_peer_key FROM [dbo].[tblPPPWithRider] [base] FULL OUTER JOIN [DataSync].[tblPPPWithRider_dss_tracking] [side] ON [base].[PPPWithRiderID] = [side].[PPPWithRiderID]
 WHERE 
