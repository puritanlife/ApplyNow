CREATE PROCEDURE [DataSync].[tblApplication_dss_bulkinsert_ac07f40e-d7b8-425c-bf97-76657090c6d0]
...
INSERT ([ApplicationID], [ProductPlanPeriodID], [UUID], [StateID], [Premium], [ForCompany], [StatusTypeID], [CanvasPolicyNumber], [CreatedDate], [LastModifiedDate], [StateLicenseTypeID]) VALUES (changes.[ApplicationID], changes.[ProductPlanPeriodID], changes.[UUID], changes.[StateID], changes.[Premium], changes.[ForCompany], changes.[StatusTypeID], changes.[CanvasPolicyNumber], changes.[CreatedDate], changes.[LastModifiedDate], changes.[StateLicenseTypeID])
