CREATE PROCEDURE [DataSync].[tblPerson_dss_selectchanges_ac07f40e-d7b8-425c-bf97-76657090c6d0]
...
ELSE @marker_scope_create_peer_key
 END) 
 end as sync_create_peer_key FROM [dbo].[tblPerson] [base] FULL OUTER JOIN [DataSync].[tblPerson_dss_tracking] [side] ON [base].[PersonID] = [side].[PersonID]
 WHERE 
