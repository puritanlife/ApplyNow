CREATE PROCEDURE [DataSync].[tblFundsType_dss_bulkupdate_6583ac21-60a9-4673-b783-62e2f2099d8a]
...
(SELECT p.*, t.update_scope_local_id, t.scope_update_peer_key, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [DataSync].[tblFundsType_dss_tracking] t ON p.[FundsTypeID] = t.[FundsTypeID]) as changes ON changes.[FundsTypeID] = base.[FundsTypeID]
