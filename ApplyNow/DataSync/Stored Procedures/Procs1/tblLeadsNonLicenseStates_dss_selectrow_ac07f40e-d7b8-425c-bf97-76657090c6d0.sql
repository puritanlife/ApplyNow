CREATE PROCEDURE [DataSync].[tblLeadsNonLicenseStates_dss_selectrow_ac07f40e-d7b8-425c-bf97-76657090c6d0]
	@P_1 Int,
...
[base].[ProductPlanPeriodID], [base].[UUID], [base].[StateID], [base].[Premium], [base].[StateLicenseTypeID], [base].[Email], [base].[CreatedDate], [base].[LastModifiedDate], (CASE WHEN [side].[local_create_peer_timestamp] IS NOT NULL 
