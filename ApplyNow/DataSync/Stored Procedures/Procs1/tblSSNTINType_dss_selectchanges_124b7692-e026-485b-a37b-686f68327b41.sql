CREATE PROCEDURE [DataSync].[tblSSNTINType_dss_selectchanges_124b7692-e026-485b-a37b-686f68327b41]
...
ELSE @marker_scope_create_peer_key
 END) 
 end as sync_create_peer_key FROM [dbo].[tblSSNTINType] [base] FULL OUTER JOIN [DataSync].[tblSSNTINType_dss_tracking] [side] ON [base].[SSNTINTypeID] = [side].[SSNTINTypeID]
 WHERE 
