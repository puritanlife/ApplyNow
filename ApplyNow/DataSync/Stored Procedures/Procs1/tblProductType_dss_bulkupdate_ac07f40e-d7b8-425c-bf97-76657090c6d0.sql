CREATE PROCEDURE [DataSync].[tblProductType_dss_bulkupdate_ac07f40e-d7b8-425c-bf97-76657090c6d0]
	@sync_min_timestamp BigInt,
	@sync_scope_local_id Int,
	@changeTable [DataSync].[tblProductType_dss_BulkType_ac07f40e-d7b8-425c-bf97-76657090c6d0] READONLY
AS
BEGIN
...
(SELECT p.*, t.update_scope_local_id, t.scope_update_peer_key, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [DataSync].[tblProductType_dss_tracking] t ON p.[ProductTypeID] = t.[ProductTypeID]) as changes ON changes.[ProductTypeID] = base.[ProductTypeID]
