CREATE PROCEDURE [DataSync].[tblLexisNexisDataElements_dss_selectchanges_6583ac21-60a9-4673-b783-62e2f2099d8a]
...
ELSE @marker_scope_create_peer_key
 END) 
 end as sync_create_peer_key FROM [dbo].[tblLexisNexisDataElements] [base] FULL OUTER JOIN [DataSync].[tblLexisNexisDataElements_dss_tracking] [side] ON [base].[LexisNexisDataElementsID] = [side].[LexisNexisDataElementsID]
 WHERE 
